...
const API = {
    ...
    getTableRelations: () => API.request('/api/mapping/table-relations'),
    saveTableRelations: (data) => API.request('/api/mapping/table-relations', { method: 'PUT', body: JSON.stringify(data) }),
